...
const images = [
  ...
  { id: 6, src: '/Captura de tela 2026-04-23 194428.png', alt: 'Foto da galeria 6' },
  { id: 7, src: '/Captura de tela 2026-06-05 083033.png', alt: 'Foto da galeria 7' },
  { id: 8, src: '/ChatGPT Image 1 de jun. de 2026, 15_46_28.png', alt: 'Foto da galeria 8' },
  { id: 9, src: '/ChatGPT Image 5 de jun. de 2026, 08_36_44.png', alt: 'Foto da galeria 9' },
];
...
export default function GaleriaSection() {
  ...
  return (
    <section id="galeria" className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-20 px-4 sm:px-6 lg:px-8">
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={handleNext}
              className="absolute -right-16 sm:right-0 top-1/2 -translate-y-1/2 sm:translate-y-0 sm:-translate-x-(-16) sm:translate-x-16 text-white hover:text-blue-400 transition-colors p-2 rounded-full hover:bg-white/10"
